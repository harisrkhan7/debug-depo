...
export BASELINE_SFT_MODEL="${BASELINE_SFT_MODEL:-Kwai-Klear/Klear-AgentForge-8B-SFT}"
export BASELINE_SFT_MODEL_REVISION="${BASELINE_SFT_MODEL_REVISION:-0da97e45dbbd44278bd55b878170ec369d2934fb}"
...
export CLOUD_SHARD_STALL_TIMEOUT_SECONDS="${CLOUD_SHARD_STALL_TIMEOUT_SECONDS:-1500}"
...
export MINI_SWE_MODEL_TIMEOUT_SECONDS="${MINI_SWE_MODEL_TIMEOUT_SECONDS:-1200}"
export CACHE_BUILD_MAX_WORKERS="${CACHE_BUILD_MAX_WORKERS:-50}"
export EVAL_MAX_WORKERS="${EVAL_MAX_WORKERS:-100}"
export EVAL_THREADS_PER_TASK="${EVAL_THREADS_PER_TASK:-1}"
